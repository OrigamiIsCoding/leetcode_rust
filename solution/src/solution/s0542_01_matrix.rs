#![allow(dead_code)]
/// reference: https://leetcode.cn/problems/01-matrix/
pub struct Solution;
...
mod tests {
    ...
    fn test_1() {
        assert_eq!(
            ...
            Solution::update_matrix(mat![[0, 0, 0], [0, 1, 0], [0, 0, 0]])
        );
    }
    ...
    fn test_2() {
        assert_eq!(
            mat![[0, 0, 0], [0, 1, 0], [1, 2, 1]],
            Solution::update_matrix(mat![[0, 0, 0], [0, 1, 0], [1, 1, 1]])
        );
    }
}
